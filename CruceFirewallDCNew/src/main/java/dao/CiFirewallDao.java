...
public class CiFirewallDao {
	...
	private static String FIREWALL_FILE_PATH = "D:\\OneDrive - GLOBAL HITSS\\2023\\11.Noviembre\\Cruces DC\\12 Firewall Administrado\\RF1674161_INVENTARIO PLATAFORMAS SEGURIDAD V21_nov23 UNMERGED - Copy.xlsx";
	private int uid;

	private  final int rowHeaderFirewallInventary=0;
	...
	public List <CiFirewall> readFirewallInventary(String firewallFilePath){
		...
		try(FileInputStream file = new FileInputStream(new File(firewallFilePath));
			...
			String typeFirewall ="";
			System.out.println(firewallSheet.getSheetName());
			System.out.println(firewallSheet.getPhysicalNumberOfRows());
