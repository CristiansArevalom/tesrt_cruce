 ...
 */
package com.matchdatacenter.cruceunix.view;

import com.matchdatacenter.cruceunix.controller.CruceUnixV2;
...
public class JFMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cruce Unix vs UCMDB vs SM Datacenter");
        setResizable(false);
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        ...
        if(!(jtfPathTorre.getText().isBlank() && jtfPathUcmdb.getText().isBlank() && jtfPathSM.getText().isBlank())){
           //
            CruceUnixV2.setUNIX_FILE_PATH(jtfPathTorre.getText());
            CruceUnixV2.setUCMDB_FILE_PATH(jtfPathUcmdb.getText());
            CruceUnixV2.setSM_FILE_PATH(jtfPathSM.getText());
    ...
    private void jbEjecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEjecutarActionPerformed
        ...
        List<String> filesPath=cruceUnix.mainController();
